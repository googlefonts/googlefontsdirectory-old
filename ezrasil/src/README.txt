README
Ezra SIL
15 June 2007 (minor updates 25 March 2011)
==========================================
...
(http://scripts.sil.org/OFL) and the MIT/X11 License (see LICENSE.txt).

More SIL fonts can be found at: http://scripts.sil.org

Ezra SIL is a trademark of SIL International.

See LICENSE.txt and OFL-FAQ.txt for details of the SIL Open Font License.
...
Encoding Conversion:
Some TECkit mappings are available on the website for text conversion between legacy and Unicode.  Unicode-Ezra-Chart17short.pdf provides a Unicode chart.
